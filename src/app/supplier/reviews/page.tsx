            ...
            >
              <div className="mt-3 space-y-2">
                <textarea
                  ...
                  className="w-full rounded-xl border border-gray-200 bg-gray-50 px-3.5 py-2.5 text-sm text-gray-900 placeholder:text-gray-400 resize-none outline-none focus:border-indigo-400 focus:shadow-[inset_0_0_0_1px_#818cf8] focus:bg-white transition-all"
                />
                <div className="flex justify-end gap-2">
                  <button
                    onClick={() => setReplyOpen(false)}
                    className="rounded-lg border border-gray-200 px-3 py-1.5 text-xs font-semibold text-gray-600 hover:border-gray-400 hover:text-gray-900 transition-all"
                  >
                    Cancel
                  </button>
                  <button
