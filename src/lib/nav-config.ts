...
export const NAV_SECTIONS: NavSection[] = [
  // ─── Admin + Super Admin ────────────────────────────────
  {
    ...
    roles: ["admin", "admin"],
    items: [
      { id: "dashboard",  label: "Dashboard",  href: "/admin",                icon: LayoutDashboard, roles: ["admin", "admin"] },
      { id: "analytics",  label: "Analytics",  href: "/admin/analytics",      icon: BarChart3,       roles: ["admin", "admin"], badge: "New", badgeVariant: "default" },
      { id: "activity",   label: "Live Feed",  href: "/admin/activity",       icon: Activity,        roles: ["admin", "admin"] },
    ],
  },
  {
    id: "admin-manage",
    ...
    roles: ["admin", "admin"],
    items: [
      { id: "suppliers",  label: "Suppliers",  href: "/admin/suppliers",      icon: Building2,       roles: ["admin", "admin"], badge: 3, badgeVariant: "warning" },
      { id: "users",      label: "Users",      href: "/admin/users",          icon: Users,           roles: ["admin", "admin"], badge: 3, badgeVariant: "danger" },
      { id: "bookings",   label: "Bookings",   href: "/admin/bookings",       icon: Calendar,        roles: ["admin", "admin"], badge: 12 },
      { id: "tickets",    label: "Tickets",    href: "/admin/tickets",        icon: Ticket,          roles: ["admin", "admin"] },
      { id: "venues",     label: "Venues",     href: "/admin/venues",         icon: MapPin,          roles: ["admin", "admin"] },
    ],
  },
  {
    id: "admin-finance",
    ...
    roles: ["admin", "admin"],
    items: [
      { id: "revenue",    label: "Revenue",    href: "/admin/revenue",        icon: TrendingUp,      roles: ["admin", "admin"] },
      { id: "payouts",    label: "Payouts",    href: "/admin/payouts",        icon: CreditCard,      roles: ["admin", "admin"] },
      { id: "reports",    label: "Reports",    href: "/admin/reports",        icon: FileText,        roles: ["admin", "admin"] },
    ],
  },
  {
    id: "admin-comms",
    ...
    roles: ["admin", "admin"],
    items: [
      { id: "reviews",    label: "Reviews",    href: "/admin/reviews",        icon: Star,            roles: ["admin", "admin"] },
      { id: "messages",   label: "Messages",   href: "/admin/messages",       icon: MessageSquare,   roles: ["admin", "admin"], badge: 5 },
      { id: "broadcasts", label: "Broadcasts", href: "/admin/broadcasts",     icon: Bell,            roles: ["admin", "admin"] },
    ],
  },
  {
    id: "admin-platform",
    ...
    roles: ["admin"],
    items: [
      { id: "approvals",  label: "Supplier Approvals", href: "/admin/approvals",  icon: ShieldCheck, roles: ["admin"], badge: 4, badgeVariant: "danger" },
      { id: "admins",     label: "Admin Accounts",     href: "/admin/admins",     icon: Shield,      roles: ["admin"] },
      { id: "categories", label: "Categories",         href: "/admin/categories", icon: Sliders,     roles: ["admin"] },
      { id: "services",   label: "All Services",       href: "/admin/services",   icon: ShoppingBag, roles: ["admin"] },
    ],
  },
  ...
  // ─── Shared bottom ─────────────────────────────────────
  {
    id: "shared-settings",
    title: "System",
    roles: ["admin", "admin", "supplier", "customer"],
    items: [
      { id: "settings", label: "Settings", href: "/admin/settings",     icon: Settings,   roles: ["admin", "admin"] },
      ...
      { id: "support",  label: "Support",  href: "/support",            icon: HelpCircle, roles: ["admin", "admin", "supplier", "customer"] },
    ],
  },
];
