/**
 * Mock conversations and messages for the chat feature.
 * Used as initial state and offline fallback when Firebase is not configured.
 * All data uses London/UK market context with £ GBP.
 */
...
/* Offset helpers so mock timestamps feel realistic */
...
export const MOCK_CONVERSATIONS: Conversation[] = [
  {
    ...
    participantNames:    { "user-current": "James Thompson", "supplier-001": "Harmony Photography" },
  ...
  },
  {
    ...
    participantNames:    { "user-current": "James Thompson", "supplier-002": "Golden Touch Catering" },
  ...
  },
  {
    ...
    participantNames:    { "user-current": "James Thompson", "supplier-003": "London Sound Pro" },
    ...
    lastMessage:  "Some Shoreditch spaces have noise restrictions after midnight — worth knowing.",
...
export const MOCK_MESSAGES: Record<string, Message[]> = {
  ...
  "conv-003": [
    ...
    },
    {
      ...
      text: "Also, do you have a venue sorted? Some Shoreditch spaces have noise restrictions after midnight — worth knowing before you book.",
