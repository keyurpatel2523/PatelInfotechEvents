        ...
        <Dialog.Content asChild>
          <motion.div
            ...
            className={cn(
              ...
              "rounded-2xl border border-[--border] bg-[--bg] shadow-[var(--shadow-xl)]",
              "focus:outline-none",
            )}
          >
            {/* Header */}
            ...
            <div className="shrink-0 flex items-center justify-between gap-3 px-6 py-4 border-t border-[--border]">
              <Dialog.Close asChild>
                <button className="rounded-xl border border-[--border] px-5 py-2.5 text-sm font-semibold text-[--text-2] hover:border-[--text-3] hover:text-[--text-1] transition-all">
                  Cancel
                </button>
              </Dialog.Close>
